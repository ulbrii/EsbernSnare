			...
			<Card>
				<Row>
					...
					<Col lg={6} md={12}>
						...
						<p>Through everything, your every part felt much more of hurt before any car the metals tore</p>
			...
			<Card>
				<Row>
					<Col lg={6} md={12}>
						...
						<br />
						<p>I've not let go of us, they found a way to burn through the nerve 'til we've never had</p>
						...
						<br />
						<p>
							The light shoots through the marks, like a million stars splintered out in a flash and flurr
						</p>
					...
					<Col lg={6} md={12}>
						...
						<p>As they come to speak in tones like i have faced the facts, when anymore I,</p>
						<p>
							I still wonder how it will work itself out where we're fine, and the headlights will turn
							through the snow in the blinds
						</p>
						<br />
						...
						<p>How's your hope?</p>
						<p>
							Do the lights lie unstring, cuz it just seems wrong to ever be fine, when the man you
							returned is the boy you refined?
						</p>
						<br />
			...
			<Card>
				<Row>
					<Col lg={6} md={12}>
						...
						<br />
						<p>Whatever those waters seem to prove</p>
					...
					<Col lg={6} md={12}>
						...
						<p>At the bottom of the stairs she cracked her head and when she went your father met</p>
			...
			<Card>
				<Row>
					<Col lg={6} md={12}>
						...
						<p>When the obvious part you've learned is she will never fold, for your worst has shown</p>
						<p>But you bore your mistakes with another, that you offered to always find</p>
						<p>You always tried</p>
						<br />
						...
						<p>
							They left you old somehow, like the kids who had pulled your sleeves and wore you down, as
							they led you unmade
						</p>
...
export default DoesItFeelLyrics;
