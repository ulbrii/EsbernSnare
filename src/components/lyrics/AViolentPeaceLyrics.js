...
function AViolentPeaceLyrics() {
	return (
		<div>
			<Card>
				<Row>
					<Col lg={6} md={12}>
						<h3>1. The Great Drowner</h3>
						<hr />
						...
						<p>the walls of frames and faces always in streams.</p>
						<br />
			...
			<Card>
				<Row>
					<Col lg={6} md={12}>
						...
						<p>but this place it was home.</p>
					</Col>
			...
			<Card>
				<Row>
					<Col lg={6} md={12}>
						...
						<p>But when you rise, will you wear your pride with the blood of what you don't need?</p>
					</Col>
					...
					<Col lg={6} md={12}>
						...
						<br />
						<p>So dig your holes for their swords and spears, but it's the minds of man that I fear.</p>
...
export default AViolentPeaceLyrics;
